...
// GlassCard Component (inlined to avoid import issues)
  ...
  const fetchStudentData = async () => {
    try {
      ...
      if (userData) {
        ...
        // Use stored XP or fallback to mock
        ...
        // No user data, use mock data and create default
